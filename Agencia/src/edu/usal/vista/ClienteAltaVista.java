...
public class ClienteAltaVista {

	public ClienteAltaVista() {

	}

	public void formularioAlta(HttpServletRequest request, HttpServletResponse response, PasaporteController pasapContr,
			TelefonoController telefContr, PasajeroFrecuenteController pasajFContr, DireccionController direcContr)
