...
public class VentaConsultaVista {

	public VentaConsultaVista() {
	}

	public void formulario_de_consulta_por_CUILyNROVuelo(HttpServletRequest request, HttpServletResponse response)
		...
		out.append("<title>Consulta de Venta</title>");
		out.append("</head>");
		out.append("<body>");
		...
		out.append("<i>");
		out.append("<u>");
		out.append("<b>Consulta de Venta</b>");
		out.append("</u>");
		out.append("</i>");
		out.append("</h1>");
		out.append("</article>");
